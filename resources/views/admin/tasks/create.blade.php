...
@section('content')
    <a class="btn btn-default mb-3" href="{{ route('admin.tasks.index') }}">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.tasks.store') }}" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-right">
                        <button class="enroll_generate_bn bg-danger" type="submit" style="margin-top:30px;">
                            {{ trans('global.save') }}
                        </button>
                    </div>
                </div>
