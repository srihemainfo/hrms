                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="regulation_id" id="regulation_id" required
                                ...
                                @foreach ($regulation as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ (old('regulation_id') ? old('regulation_id') : $subject->regulation_id) == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="department_id" id="department_id" required
                                ...
                                @foreach ($department as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ (old('department_id') ? old('department_id') : $subject->department_id ?? '') == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="course_id" id="course_id" required
                                ...
                                @foreach ($course as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ (old('course_id') ? old('course_id') : $subject->course_id ?? '') == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="semester_id" id="semester_id">
                                @foreach ($semester as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ (old('semester_id') ? old('semester_id') : $subject->semester_id ?? '') == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="subject_type_id" id="subject_type_id" required>
                                @foreach ($subject_type as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ (old('subject_type_id') ? old('subject_type_id') : $subject->subject_type_id) == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="subject_cat_id" id="subject_cat_id" required>
                                @foreach ($subject_cat as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ (old('subject_cat_id') ? old('subject_cat_id') : $subject->subject_cat_id) == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="lecture" id="lecture"
                                value="{{ $subject->lecture }}" required>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tutorial" id="tutorial"
                                value="{{ $subject->tutorial }}" required>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="practical" id="practical"
                                value="{{ $subject->practical }}" required>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="contact_periods" id="contact_periods"
                                value="{{ $subject->contact_periods }}" required>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="credits" id="credits"
                                value="{{ $subject->credits }}" required onchange="checkCredit(this)">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="form-group">
