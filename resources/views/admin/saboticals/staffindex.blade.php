    ...
    <div class="row gutters">
        ...
        <div class="col" style="padding:0;">
            <div class="card h-100">
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('admin.saboticals.staff_update', ['user_name_id' => $staff->user_name_id, 'name' => $staff->name, 'id' => $staff_edit->id]) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <h5 class="mb-2 text-primary">Saboticals Details</h5>
                            </div>
                            ...
                            {{-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="eligiblity_approve">Eligiblity Approve</label>
                                    <input type="text" class="form-control" id="eligiblity_approve"
                                        name="eligiblity_approve" placeholder="Enter Eligiblity Approve"
                                        value="{{ $staff_edit->eligiblity_approve }}">
                                </div>
                            </div> --}}
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date" id="from" name="from"
                                        placeholder="Enter From Date" value="{{ $staff_edit->from }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date" name="to"
                                        placeholder="Enter To Date" value="{{ $staff_edit->to }}">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col" style="padding:0;">
                ...
                @endphp
                    <div class="card-body table-responsive">
                        <h5 class="mb-3 text-primary">Saboticals  List</h5>
                                    ...
                                    <tr>
                                        ...
                                        @if ($userId == 1)
                                            @if ($list[$i]->status == '0')
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('admin.saboticals.staff_updater', ['user_name_id' => $staff->user_name_id, 'name' => $staff->name, 'id' => $list[$i]->id]) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('admin.saboticals.destroy', $list[$i]->id) }}"
                                                        method="POST"
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.saboticals.destroy', $list[$i]->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
                                                <input type="hidden" name="_method" value="DELETE">
