...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.subject_category.update', [$subjectCategory->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="regulation_id" id="regulation_id" required>
                        @foreach ($regulations as $id => $entry)
                                ...
                                <option value="{{ $id }}" {{ $subjectCategory->regulation_id == $id ? 'selected':'' }}>{{ $entry }}</option>
                ...
                <div class="form-group">
                    ...
                    <input style="text-transform:uppercase;"
                        ...
                        id="name" value="{{ old('name', $subjectCategory->name) }}"
