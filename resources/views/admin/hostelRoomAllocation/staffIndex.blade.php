        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
            <div class="card text-Dark shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <span class="card-title text-primary">Students Count</span>
                        </div>
                        <div class="col text-center">
    ...
    <script>
        ...
        function callAjax() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.room-allot.staffIndex') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (status == true) {
                            ...
                            $("#hostel_room").select2();
                            $("#available_slots").html(data.hostel_room.available_slots != null ? data
                                .hostel_room.available_slots : 0);
                            $("#total_slots").val(data.hostel_room.total_slots)
                            $('.roomViews').show();
                            $('.slot').hide();
                            $("#save_div").hide();
                            $(".roomViews").show();
