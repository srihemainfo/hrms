    ...
    <div class="row gutters">
        ...
        <div class="col" style="padding:0;">
            <div class="card h-100">
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('admin.interns.staff_update', ['user_name_id' => $staff->user_name_id, 'name' => $staff->name, 'id' => $staff_edit->id]) }}"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="progress_report"
                                        placeholder="Enter Progress Report" value="{{ $staff_edit->progress_report }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
            ...
            <div class="col" style="padding:0;">
                ...
                @endphp
                    <div class="card-body table-responsive">
                        <h5 class="mb-3 text-primary">Interns Details List</h5>
                                    ...
                                    <tr>
                                        ...
                                        @if ($userId == 1)
                                            @if ($list[$i]->status == '0')
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('admin.interns.staff_updater', ['user_name_id' => $staff->user_name_id, 'name' => $staff->name, 'id' => $list[$i]->id]) }}"
