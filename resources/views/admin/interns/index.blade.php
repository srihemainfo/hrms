...
@can('intern_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.interns.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Intern">
            <thead>
                <tr>
                    <th width="10">
...
@can('intern_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.interns.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.interns.index') }}",
    columns: [
...
{ data: 'progress_report', name: 'progress_report' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Intern').DataTable(dtOverrideGlobals);
