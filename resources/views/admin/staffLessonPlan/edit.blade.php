        ...
        <div class="card-body">
            ...
            <div style="display:flex;justify-content:space-between;">
                ...
                <div>
                    ...
                    <button class="enroll_generate_bn bg-success" onclick="update()">Update</button>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        function update() {
            ...
            Swal.fire({
                title: "Are You Sure?",
                text: "Do You Want To Update The Lesson Plan ?",
                icon: "warning",
                showCancelButton: true,
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{ route('admin.staff-subjects.lesson-plan.update') }}',
                        type: 'POST',
                        data: data,
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        ...
                        success: function(response) {
                            // console.log(response)
                            if (response.status == true) {
                                Swal.fire('', 'Lesson Plan Submitted!', 'success');
