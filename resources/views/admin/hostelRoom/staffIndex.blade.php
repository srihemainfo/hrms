        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="card text-Dark shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <span class="card-title text-primary">Total Rooms</span>
                        </div>
                        <div class="col text-center">
                            <span class="card-title">{{ $room_count }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="card text-Dark shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <span class="card-title text-primary">Filled Slots</span>
                        </div>
                        <div class="col text-center">
                            <span class="card-title">{{ $filled }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="card text-Dark shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <span class="card-title text-primary">Available Slots</span>
                        </div>
                        <div class="col text-center">
    ...
    <script>
        ...
        function callAjax() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.hostelRoom.roomStaffIndex') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
