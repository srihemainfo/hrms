            ...
            <div class="col-md-10 border">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="row">
                            <div class="col-md-6">
                                <div> <span class="width font pl-4">Staff Code :</span> <small
                                        class="ms-3 font">{{ !isset($results->StaffCode) ? '' : $results->StaffCode }}</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div> <span class="fw-bolder font pl-4 font">Name :</span> <small
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div> <span class="fw-bolder font pl-4 font">Department :</span> <small
                                        class="ms-3">{{ !isset($results->department) ? '' : $results->department }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div> <span class="fw-bolder font pl-4"></span><span class="width">Date Of Joining :</span>
                                    <small class="ms-3">{{ !isset($results->DOJ) ? '' : $results->DOJ }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div><span class="width font pl-4 font"> Bank Name :</span> <small
