    ...
    <div class="row gutters">
        ...
        <div class="col" style="padding:0;">
            <div class="card h-100">
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('admin.ivs.staff_update', ['user_name_id' => $staff->user_name_id, 'name' => $staff->name, 'id' => $staff_edit->id]) }}"
            ...
            <div class="col" style="padding:0;">
                ...
                @endphp
                    <div class="card-body table-responsive">
                        <h5 class="mb-3 text-primary">IV Details List</h5>
                                    ...
                                    <tr>
                                        ...
                                        @if ($userId == 1)
                                            @if ($list[$i]->status == '0')
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('admin.ivs.staff_updater', ['user_name_id' => $staff->user_name_id, 'name' => $staff->name, 'id' => $list[$i]->id]) }}"
