                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="id" value="{{ $getData->id }}">
                            <select name="cer_type" id="certificate" class="form-control select2">
                                <option value="" {{ $getData->certificate == '' ? 'selected' : '' }}>Select
                                    Certificate
                                </option>
                                <option value="BONAFIDE" {{ $getData->certificate == 'BONAFIDE' ? 'selected' : '' }}>
                                    BONAFIDE
                                    CERTIFICATE</option>
                            </select>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="date" id="date" class="form-control date"
                                value="{{ $getData->date }}" placeholder="Select Date">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                ...
                                <select name="purpose_type" id="purpose_type" class="form-control select2">
                                    ...
                                    @foreach ($getData->get_reasons as $id => $reason)
                                        <option value="{{ $reason }}"
                                            {{ $getData->purpose == $reason ? 'selected' : '' }}>{{ $reason }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-xl-1 col-lg-1 col-md-1 col-sm-5 col-5">
                                <div class="form-check form-check-inline" style='padding-top:32px'>
                                    <input class="form-check-input" id='checkbox' type="checkbox" value="Hostel"
                                        ...
                                        {{ $getData->hostelcheck ? ($getData->hostelcheck == 'Hostel' ? 'checked' : '') : '' }}>
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-7 col-7" id="hostel_no_div"
                                style="display:{{ $getData->hostelcheck ? ($getData->hostelcheck == 'Hostel' ? 'block' : 'none') : 'none' }};">
                                <label for="hostel_no" style="margin-left:8px;">Hostel Room No</label>
                                <input type="text" class="form-control" name="hostel_no" id="hostel_no"
                                    value="{{ $getData->hostel_no ? $getData->hostel_no : '' }}"
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group" id='bonafide_other_type' style='display:none;'>
                            ...
                            <input type="hidden" name="hostelmessage" id="hostelmessage" class="form-control"
                                placeholder="Enter The Reason For Applying"
                                {{ $getData->hostelmessage ? $getData->hostelmessage : '' }}>
                        </div>
                    </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (status == true) {
                                    ...
                                    $.ajax({
                                        url: '{{ route('admin.student-apply-certificate.update') }}',
                                        type: 'POST',
                                        data: {
                                            'id': id,
                                            'date': date,
