    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hrm-request-leaves.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_date') ? 'is-invalid' : '' }}" type="date" name="from_date" id="from_date" value="{{ old('from_date', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('to_date') ? 'is-invalid' : '' }}" type="date" name="to_date" id="to_date" value="{{ old('to_date', '') }}">
