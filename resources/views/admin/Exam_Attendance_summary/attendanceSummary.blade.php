...
@section('content')
    ...
    <div class="card">
        <div class="card-header text-center">
            <span class="text-primary" style="font-size:1.2rem"> <strong> CAT Absentees Report </strong></span>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="form-group ">
                        <label for="department" class="required d-block">Department</label>
                ...
                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="form-group">
                        <label for="search_date" class="required d-block">Date</label>
                ...
                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12" style="padding-top: 32px;">
                    <button class="enroll_generate_bn" onclick="search()">Filter</button>
                </div>
            </div>
    ...
    <div class="card" style="display: none" id="mainCard">
        <div class="card-header text-center">
            <span class="text-primary" style="font-size:1.2rem"> <strong> CAT Absentees List </strong></span>
        </div>
        <div class="card-body">
            ...
            <div  style="float:right" class='form-group col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mt-xl-0 mt-lg-0 mt-md-0 mt-sm-2 mt-2' >
    ...
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (status != false) {
                            ...
                            $("#card_header").html(`<a class="enroll_generate_bn bg-success" target="blank" href="{{ URL::to('admin/absentees-summary-report/pdf/${dept}/${course}/${ay}/${sem_type}/${theDate}') }}">
                    Download PDF File
                 </a>`);
        ...
        $(document).ready(function() {
            ...
            function dateShow(selectedValue) {
                ...
                $("#loading").show();
                $.ajax({
                    url: "{{ route('admin.Exam_AttendanceSummary.getDate') }}",
                    type: "POST",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function getSemester() {
                ...
                if (academicYear_id != '' && course_id != '' && semester_id != '') {
                    ...
                    $.ajax({
                        url: "{{ route('admin.Exam_AttendanceSummary.Subject_get') }}",
                        type: "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
        ...
        function search() {
            ...
            $.ajax({
                url: "{{ route('admin.Exam_AttendanceSummary.search') }}",
                method: 'POST',
                data: data,
                success: function(response) {
        ...
        // }
                    ...
                    if (response.data != undefined && response.data.length > 0) {
                        ...
                        let link = `{{ url('admin/Exam-absentees-report/pdf/${id}/${academicYear_id}/${year}/${semester_id}/${date}/${department}/${course_id}/${exameName}') }}`;
