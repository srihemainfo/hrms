        ...
        foreach ($startDatesArray as $object) {
            ...
            $dayorder = $object->dayorder;
                ...
                if ($dayorder == 1 || $dayorder == 2) {
                    $style .= 'background: #FFD5D6; box-shadow: inset 0 0 0 1px #E0E0E0;width: 100px;';
                } elseif ($dayorder == 3) {
                    $style = 'background: #FFD5D6; box-shadow: inset 0 0 0 1px #E0E0E0;width: 100px;';
                } elseif ($dayorder == 0) {
                    $style = 'width: 100px;';
                } elseif ($dayorder == 4) {
                    $style = 'background: #FFD5D6; box-shadow: inset 0 0 0 1px #E0E0E0;color:#010101;width: 100px;';
                    ...
                    $style = 'background: #de6c9d; box-shadow: inset 0 0 0 1px #E0E0E0;color:#010101; width: 100px;';
                    $dayNameShort = '';
                } elseif ($dayorder == 7) {
                    $style = 'width: 100px;';
                    $dayNameShort = '(Tue)';
            ...
            $('#save').on('click', function() {
                ...
                $('.select3').each(function(index, val) {
                    if ($(val).val() != "00") {
                        ...
                        var batch = $(this).closest('.year_label').data(
                            'batch'); // Retrieve the batch value from the parent '.year' element
