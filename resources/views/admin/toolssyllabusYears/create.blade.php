    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.toolssyllabus-years.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2  {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" id="name" value="{{ old('name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="month" class="form-control" name="year" value="" required>
            </div>
            <div class="form-group">
