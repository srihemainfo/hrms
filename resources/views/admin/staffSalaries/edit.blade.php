...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} Staff Salary
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff-salaries.update", [$staffSalary->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="staff_code">Staff Code</label>
                <input class="form-control {{ $errors->has('staff_code') ? 'is-invalid' : '' }}" type="text" name="staff_code" id="staff_code" value="{{ old('staff_code', $staffSalary->staff_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biometric') ? 'is-invalid' : '' }}" type="text" name="biometric" id="biometric" value="{{ old('biometric', $staffSalary->biometric) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('staff_name') ? 'is-invalid' : '' }}" type="text" name="staff_name" id="staff_name" value="{{ old('staff_name', $staffSalary->staff_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" type="text" name="department" id="department" value="{{ old('department', $staffSalary->department) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $staffSalary->designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_joining') ? 'is-invalid' : '' }}" type="text" name="date_of_joining" id="date_of_joining" value="{{ old('date_of_joining', $staffSalary->date_of_joining) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_working_days') ? 'is-invalid' : '' }}" type="text" name="total_working_days" id="total_working_days" value="{{ old('total_working_days', $staffSalary->total_working_days) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('loss_of_pay') ? 'is-invalid' : '' }}" type="text" name="loss_of_pay" id="loss_of_pay" value="{{ old('loss_of_pay', $staffSalary->loss_of_pay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_day_payable') ? 'is-invalid' : '' }}" type="text" name="no_of_day_payable" id="no_of_day_payable" value="{{ old('no_of_day_payable', $staffSalary->no_of_day_payable) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_gross_salary') ? 'is-invalid' : '' }}" type="text" name="actual_gross_salary" id="actual_gross_salary" value="{{ old('actual_gross_salary', $staffSalary->actual_gross_salary) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('basic_pay') ? 'is-invalid' : '' }}" type="text" name="basic_pay" id="basic_pay" value="{{ old('basic_pay', $staffSalary->basic_pay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agp') ? 'is-invalid' : '' }}" type="text" name="agp" id="agp" value="{{ old('agp', $staffSalary->agp) }}">
                @if($errors->has('agp'))
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('da') ? 'is-invalid' : '' }}" type="text" name="da" id="da" value="{{ old('da', $staffSalary->da) }}">
                @if($errors->has('da'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hra') ? 'is-invalid' : '' }}" type="number" name="hra" id="hra" value="{{ old('hra', $staffSalary->hra) }}" min="0" max="100">
                @if($errors->has('hra'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('arrears') ? 'is-invalid' : '' }}" type="text" name="arrears" id="arrears" value="{{ old('arrears', $staffSalary->arrears) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('special_pay') ? 'is-invalid' : '' }}" type="text" name="special_pay" id="special_pay" value="{{ old('special_pay', $staffSalary->special_pay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_allowances') ? 'is-invalid' : '' }}" type="text" name="other_allowances" id="other_allowances" value="{{ old('other_allowances', $staffSalary->other_allowances) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('appraisal_based_increment') ? 'is-invalid' : '' }}" type="text" name="appraisal_based_increment" id="appraisal_based_increment" value="{{ old('appraisal_based_increment', $staffSalary->appraisal_based_increment) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phd_allowance') ? 'is-invalid' : '' }}" type="text" name="phd_allowance" id="phd_allowance" value="{{ old('phd_allowance', $staffSalary->phd_allowance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gross_salary') ? 'is-invalid' : '' }}" type="text" name="gross_salary" id="gross_salary" value="{{ old('gross_salary', $staffSalary->gross_salary) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('it') ? 'is-invalid' : '' }}" type="text" name="it" id="it" value="{{ old('it', $staffSalary->it) }}">
                @if($errors->has('it'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pt') ? 'is-invalid' : '' }}" type="text" name="pt" id="pt" value="{{ old('pt', $staffSalary->pt) }}">
                @if($errors->has('pt'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salary_advance') ? 'is-invalid' : '' }}" type="text" name="salary_advance" id="salary_advance" value="{{ old('salary_advance', $staffSalary->salary_advance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_deduction') ? 'is-invalid' : '' }}" type="text" name="other_deduction" id="other_deduction" value="{{ old('other_deduction', $staffSalary->other_deduction) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('esi') ? 'is-invalid' : '' }}" type="text" name="esi" id="esi" value="{{ old('esi', $staffSalary->esi) }}">
                @if($errors->has('esi'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('epf') ? 'is-invalid' : '' }}" type="text" name="epf" id="epf" value="{{ old('epf', $staffSalary->epf) }}">
                @if($errors->has('epf'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_deductions') ? 'is-invalid' : '' }}" type="text" name="total_deductions" id="total_deductions" value="{{ old('total_deductions', $staffSalary->total_deductions) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('net_salary') ? 'is-invalid' : '' }}" type="text" name="net_salary" id="net_salary" value="{{ old('net_salary', $staffSalary->net_salary) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" type="text" name="remarks" id="remarks" value="{{ old('remarks', $staffSalary->remarks) }}">
