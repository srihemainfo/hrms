...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.Result_Analysis_Class_Wise.get') }}" method="post" enctype="multipart/form-data">
            @csrf
...
<div class="card" id="report" style="text-align:center;">
    ...
    <div class="row card-header ">
        ...
        <div class=" col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-xl-0 mb-lg-0 mb-md-0 mb-sm-2 mb-2">
            <a href="{{ URL::to('admin/Exam-classWise-summary-report/pdf', ['ay'=> $newData['Ay'], 'year'=> $newData['Year'], 'sem' => $newData['Sem'], 'examname'=> base64_encode($newData['Ex']), 'course'=> $newData['Course'],'section' => $newData['Sec']]) }}" target="_blank" class="btn btn-primary" id="download_btn">Download PDF File</a>
        </div>
...
<script>
    function ExportToExcel(type, fn, dl) {
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || (`Result_Analysis_Report_${{{  $response[0]->className ?? '' }}}.` + (type || 'xlsx')));
    }
