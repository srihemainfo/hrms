...
@section('scripts')
    ...
    <script>
        ...
        // Call the initializeChart function to create the initial empty chart
        initializeChart();
        ...
        function search() {
            ...
            $.ajax({
                url: "{{ route('admin.Result_Analysis_bar_chart.showChart') }}",
                method: 'POST',
                headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < labelColors.length; i++) {
                        ...
                        var groupData = responseArray[labelColor
                        .label]; // Assuming your data is organized by label
