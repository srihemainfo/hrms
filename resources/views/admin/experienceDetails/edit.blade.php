...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.experience-details.update", [$experienceDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="designation">{{ trans('cruds.experienceDetail.fields.designation') }}</label>
                <input class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $experienceDetail->designation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('years_of_experience') ? 'is-invalid' : '' }}" type="number" name="years_of_experience" id="years_of_experience" value="{{ old('years_of_experience', $experienceDetail->years_of_experience) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('worked_place') ? 'is-invalid' : '' }}" type="text" name="worked_place" id="worked_place" value="{{ old('worked_place', $experienceDetail->worked_place) }}">
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taken_subjects') ? 'is-invalid' : '' }}" type="text" name="taken_subjects" id="taken_subjects" value="{{ old('taken_subjects', $experienceDetail->taken_subjects) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('from_date') ? 'is-invalid' : '' }}" type="text" name="from_date" id="from_date" value="{{ old('from_date', $experienceDetail->from_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('to_date') ? 'is-invalid' : '' }}" type="text" name="to_date" id="to_date" value="{{ old('to_date', $experienceDetail->to_date) }}" required>
