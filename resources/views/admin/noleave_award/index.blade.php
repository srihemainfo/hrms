...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card" id="report" style="display:none;max-width:fix-content;overflow-x:auto;z-index:0;">
            <div class="card-header text-center text-primary" id="card_header">NoLeave Monthly Wise Report</div>
    ...
    @section('scripts')
        ...
        <script>
            ...
            function get_data() {
                ...
                $('.secondLoader').show()
                $.ajax({
                    url: "{{ route('admin.noleave_award.get-data') }}",
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
