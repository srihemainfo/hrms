    ...
    <div class="card-body" id="one">
        <div>
            ...
            <div class="form-group required">
                ...
                <select id="myDropdown" class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" name="roles" required>
            ...
            <div class="form-group studentDiv" style="display: none" id="AdminDiv">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" style="text-transform:uppercase;" type="text" name="name" id="name" value="{{ old('name', '') }}">
                @if ($errors->has('name'))
            ...
            <div class="form-group" style="display: none" id="namefull">
                <label class="required" for="name">Name</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" style="text-transform:uppercase;" type="text" name="fullname" id="fname" value="{{ old('fullname', '') }}">
            ...
            <div class="form-group staff" style="display: none">
                ...
                <input class="form-control {{ $errors->has('firstname') ? 'is-invalid' : '' }} " style="text-transform:uppercase;" type="text" name="firstname" id="firstname" value="{{ old('firstname', '') }}">
            ...
            <div class="form-group staff" style="display: none">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" style="text-transform:uppercase;" type="text" name="last_name" id="last_name" value="{{ old('last_name', '') }}">
            ...
            <div class="form-group doj" style="display: none;">
                ...
                <input type="text" id="doj" class="form-control date" name="doj" placeholder="Enter Date Of Joining" required>
            </div>

            <div class="form-group staff" style="display: none">
                <label class="required" for="staff_code">{{ 'Staff Code' }}</label>
                <input class="form-control {{ $errors->has('StaffCode') ? 'is-invalid' : '' }}" type="text" name="StaffCode" id="StaffCode" value="{{ old('StaffCode', '') }}">
            ...
            <div class="form-group studentDiv" style="display: none">
                ...
                <input class="form-control {{ $errors->has('register_no') ? 'is-invalid' : '' }}" type="number" name="register_no" id="register_no" value="{{ old('register_no', '') }}" step="1">
            ...
            <div class="form-group studentDiv" style="display: none">
                <label class="required" for="enroll_master_id">{{ trans('cruds.student.fields.enroll_master') }}</label>
            ...
            <div class="form-group studentDiv" style="display: none">
                ...
                <input class="form-control {{ $errors->has('rollNumber') ? 'is-invalid' : '' }}" type="rollNumber" name="rollNumber" id="rollNumber" value="{{ old('rollNumber') }}">
...
<script>
    ...
    $('#btnsave').click(function() {
        ...
        var data = ''
        if (role_type != '' && role != '') {
            if ((role_type == 1 || role_type == 3 || role_type == 2 || role_type == 4 || role_type == 5) && firstname != '' && doj != '' && last_name != '' && Dept != '' && Designation != '' && StaffCode != '' && email != '' && phone != '' && role_type != '') {
                data = {
                    'firstname': firstname,
                    'last_name': last_name,
                    'Dept': Dept,
                ...
                if (role == 11 && name != '' && email != '' && register_no != '' && enroll_master_id != '' && rollNumber != '' && phone != '' && role_type != '') {
                    data = {
                        'name': name,
                        'email': email,
