    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.teaching-staffs.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" style="text-transform:uppercase;" type="text" name="last_name" id="name" value="{{ old('last_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }} " type="number" name="phone" id="name" value="">
            </div>
            <div class="form-group">
