        ...
        <div class="card-body">
            <div class="card" id="stu_list_card" style="display: block">
                ...
                <div class="card" id="stu_list_card" style="display: block">
                    ...
                    <div class="card-body text-center" id="stu_list">
                        <form method="POST" onsubmit="return disableBtn(this)" action="{{ route('admin.exam_attendance.attendenceUpdate') }}"
                            ...
                            <button type="submit" id='submit_button' class="btn btn-primary mt-2">Save</button>
                        </form>
