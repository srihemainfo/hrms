...
@can('fundingdetali_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.fundingdetalis.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Fundingdetali">
            <thead>
                <tr>
                    <th width="10">
...
@can('fundingdetali_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fundingdetalis.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.fundingdetalis.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Fundingdetali').DataTable(dtOverrideGlobals);
