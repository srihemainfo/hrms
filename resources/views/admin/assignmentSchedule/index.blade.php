...
@section('content')
    ...
    <div style="margin-bottom: 10px; display:flex;" class="row ">
        <div class="pl-2">
            <a class="btn btn-success" href="{{ route('admin.assignment_schedule.create') }}">
        ...
        <div class="card-body">
            ...
            <div style="display: none" class="col-12" id="firstHide">
                <div class=" row">
                    ...
                    <div class="form-group col-xl-3 col-lg-3  col-md-4 col-sm-6 col-12">
                        <label for="Section" class="d-block">Section</label><br>
                        <select class="form-control select2" name="Section" id="section">
                            <option value="">Please Select</option>
                            <option value="A">A</option>
                            <option value="B">B</option>
    ...
    <div class="card">
        <div class="card-header text-center">
            <strong> Assignment Schedule {{ trans('global.list') }}</strong>
        </div>
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.assignment.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
        ...
        function search() {
            ...
            $.ajax({
                url: "{{ route('admin.assignment_schedule.search') }}",
                method: 'POST',
                data: data,
