                ...
                <div class="card h-100 ">
                    <div class="card-body">
                        <div class="row gutters">
                            ...
                            @if ($detail->designation_id != '')
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="designation_id">Designation</label>
                                        @foreach ($detail->designation as $id => $des)
                                            @if ($detail->designation_id == $id)
                                                <input type="text" class="form-control" value="{{ $des }}"
                                                    readonly>
                                            @endif
                                        @endforeach
                                    </div>
                            ...
                            @if ($detail->role_id != '')
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        @foreach ($detail->role as $id => $rld)
                                            @if ($detail->role_id == $id)
                                                <input type="text" class="form-control" value="{{ $rld }}"
                                                    readonly>
                                            @endif
                                        @endforeach
                                    </div>
                    ...
                    <div class="card-body view_more" style="display:none;">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="StaffCode">Employee ID</label>
                                        <input type="text" class="form-control" id="StaffCode" name="StaffCode"
                                            value="{{ $detail->employee_id }}" readonly>
                                    </div>
                                </div>
                                {{-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mobile_number"
                                            name="mobile_number" value="{{ $detail->phone_number }}" readonly>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="emergency_contact_no"
                                            value="{{ $detail->emergency_contact_no }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="PanNo"
                                            value="{{ $detail->pan_number }}" readonly>
                                    </div>
                                </div>
                                {{-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                ...
                                @if ($detail->mother_tongue_id != '')
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="mother_tongue_id">Mother Tounge</label>
                                ...
                                @if ($detail->state_id != '')
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            @foreach ($detail->state as $id => $sts)
                                                @if ($detail->state_id == $id)
                                                    <input type="text" class="form-control"
                                                        value="{{ $sts }}" readonly>
                                                @endif
                                            @endforeach
                                ...
                                @endif
                                @if ($detail->nationality_id != '')
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="nationality_id">Country</label>
                                            @foreach ($detail->nationality as $id => $nat)
                                                @if ($detail->nationality_id == $id)
                                                    <input type="text" class="form-control"
                                                        value="{{ $nat }}" readonly>
                                                @endif
                                            @endforeach
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($salary_list); $i++)
                                            <tr>
                                                ...
                                                <td>{{ $salary_list[$i]->hra_amount }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($leave_list[$i]->assigning_staff)
                                                        @php
                                                            $staffs = $leave_list[$i]->assigning_staff;
                ...
                <div class="col" style="padding:0;">
                    <div class="card ">
                        <div class="card-header">
                            <div class="row gutters">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <h5 style="margin-bottom:0;margin-top:3px;" class="text-primary">Event Participation
                                        Details</h5>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" style="text-align:end;">
                                    <h5 style="margin-bottom: 0;"><i class="right fa fa-fw fa-angle-left add_plus"
                                ...
                                <tbody>
                                    @for ($i = 0; $i < count($event_participation_details_list); $i++)
                                        <tr>
                                            ...
                                            @if ($event_participation_details_list[$i]->event_type != '' || $event_participation_details_list[$i]->event_type != null)
                                            ...
                                            @if ($event_participation_details_list[$i]->certificate != '' && $event_participation_details_list[$i]->certificate != null)
                                                <td>
                                                    <img class="uploaded_img"
                ...
                <div class="col" style="padding:0;">
                    <div class="card ">
                        <div class="card-header">
                            <div class="row gutters">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <h5 style="margin-bottom:0;margin-top:3px;" class="text-primary">Publication Details
                                    </h5>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" style="text-align:end;">
                                    <h5 style="margin-bottom: 0;"><i class="right fa fa-fw fa-angle-left add_plus"
    ...
    {{-- <div class="row gutters" style="margin:7.5px 0px 0px 0px;">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding: 0;">
            <div class="text-right">
                <button type="button" id="view_btn" class="manual_bn">View More</button>
            </div>
        </div>
    </div> --}}
    </div>
