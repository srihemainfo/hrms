...
@section('content')
    @can('non_teaching_staff_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.non-teaching-staffs.create') }}">
                ...
                @include('csvImport.modal', [
                    ...
                    'route' => 'admin.non-teaching-staffs.parseCsvImport',
                ])
            </div>
        </div>
    @endcan
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-NonTeachingStaff">
                <thead>
                    <tr>
                        <th width="10">
        ...
        $(function() {
            ...
            @can('non_teaching_staff_delete')
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('admin.non-teaching-staffs.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.non-teaching-staffs.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            let table = $('.datatable-NonTeachingStaff').DataTable(dtOverrideGlobals);
