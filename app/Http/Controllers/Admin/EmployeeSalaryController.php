...
class EmployeeSalaryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.employeeSalary.index', compact('staff', 'attend_rep', 'year'));
    }
    ...
    public function search(Request $request)
    {
        ...
        if ($request) {
            ...
            if (!$query->count() <= 0) {
                ...
                $salary_query = TeachingStaff::where('user_name_id', $query[0]->user_name_id)->first();
        ...
        $year = Year::select('id', 'year')->get();
        return view('admin.employeeSalary.index', compact('attend_rep', 'staff', 'day_array', 'salary', 'bank', 'doj', 'half_day_leave', 'leave', 'year', 'too_late'));
    }
